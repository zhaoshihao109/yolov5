...
if __name__ == '__main__':
    ...
    out_root_path = r'F:\postgraduate study\Project\tea_lavel\TEA_SINGLE_OVERWIEW_5_v0.5\outAugment' #输出路径

    source_pic_root_path = r'F:\postgraduate study\Project\tea_lavel\TEA_SINGLE_OVERWIEW_5_v0.5\images'
    source_xml_root_path = r'F:\postgraduate study\Project\tea_lavel\TEA_SINGLE_OVERWIEW_5_v0.5\Annotations'
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        for i,file in enumerate(files):
            ...
            while cnt < need_aug_num:
                ...
                aug_img_name = file[0:-4] + '_aug_' + str(cnt) + file[-4:]
